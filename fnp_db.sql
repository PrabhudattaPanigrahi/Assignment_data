...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2021 at 02:13 PM
...
(0, 'Prabhudatta', '$2y$10$VxJg1umh1EfzarBQn1Ga2OjuAME/NjiQ3GYkVFf/uWHvF30R3Gc36');

-- --------------------------------------------------------

--
-- Table structure for table `view_json`
--

CREATE TABLE `view_json` (
...
--
-- Dumping data for table `view_json`
--

INSERT INTO `view_json` (`userId`, `id`, `title`, `body`) VALUES
